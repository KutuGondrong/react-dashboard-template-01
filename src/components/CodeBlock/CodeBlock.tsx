    ...
    >
      ...
      {isOpen ? (
        <div className="w-full min-w-0 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className={cn('min-w-0', compact ? 'px-3 pb-2' : 'px-4 pb-2')}>
            <pre
              ref={preRef}
              className="w-full min-w-0 max-w-full overflow-x-auto whitespace-pre rounded-lg bg-gray-900 px-3 py-2 font-mono text-xs leading-normal text-green-400"
            >
