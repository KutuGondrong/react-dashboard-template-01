...
help:
	...
	@echo "  make feature name=X [scope=full|hook|page] [label=\"Name\"] [label-id=\"Nama\"] - Scaffold menu + page"
	@[ -f Makefile.creator ] && $(MAKE) --no-print-directory template-help || true
